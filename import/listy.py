...
script spustit příkazem: python web2py.py -a "pwd" -M -S edga -R applications/edga/import/listy.py
...
folder_src = r"c:\ramovani\data\fox" 
...
def import_listy_rp():
    ...
    fox_listy = fox_table(folder_src, "listy")
